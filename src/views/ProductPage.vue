<template>
	<div class="bg-neutral-100">
		...
		<div class="container md:h-[90vh]">
			<!-- Product Section -->
			<div class="py-4 md:py-8 px-4 md:px-8 flex flex-col justify-start md:justify-between md:flex-row">
				...
				<div class="flex-col md:w-[48%] bg-neutral-100">
					<!-- Brand & Stock -->
